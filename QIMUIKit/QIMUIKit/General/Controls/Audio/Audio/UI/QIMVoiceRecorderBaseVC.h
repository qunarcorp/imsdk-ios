...
@protocol QIMVoiceRecorderBaseVCDelegate <NSObject>

//录音完成回调，返回文件路径和文件名
- (void)QIMVoiceRecorderBaseVCRecordFinish:(NSString *)_filePath fileName:(NSString*)_fileName;
- (void)VoiceRecorderDidFinishWithAmrData:(NSData *)_amrData WithDuration:(int)duration;

@end

@interface QIMVoiceRecorderBaseVC : UIViewController{
...
@property (assign, nonatomic)           id<QIMVoiceRecorderBaseVCDelegate> vrbDelegate;
