...
#import "QIMViewStorage.h"

@interface QIMTextContainer : NSObject
...
@interface QIMTextContainer (Add)
/**
...
#pragma mark - append
@interface QIMTextContainer (Append)
...
#pragma mark - Link
@interface QIMTextContainer (Link)
...
@interface QIMTextContainer (UIImage)
...
@interface QIMTextContainer (UIView)
