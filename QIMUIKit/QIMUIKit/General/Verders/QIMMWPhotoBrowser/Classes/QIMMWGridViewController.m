...
@interface QIMMWGridViewController () {
...
@implementation QIMMWGridViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.collectionView registerClass:[QIMMWGridCell class] forCellWithReuseIdentifier:@"GridCell"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if (visibleCells) {
        for (QIMMWGridCell *cell in visibleCells) {
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    QIMMWGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GridCell" forIndexPath:indexPath];
    if (!cell) {
        cell = [[QIMMWGridCell alloc] init];
    }
    id <QIMMWPhoto> photo = [_browser thumbPhotoAtIndex:indexPath.row];
    cell.photo = photo;
...
- (void)collectionView:(UICollectionView *)collectionView didEndDisplayingCell:(UICollectionViewCell *)cell forItemAtIndexPath:(NSIndexPath *)indexPath {
    [((QIMMWGridCell *)cell).photo cancelAnyLoading];
}
