...
// Notifications
#define QIMMWPHOTO_LOADING_DID_END_NOTIFICATION @"QIMMWPHOTO_LOADING_DID_END_NOTIFICATION"
#define QIMMWPHOTO_PROGRESS_NOTIFICATION @"QIMMWPHOTO_PROGRESS_NOTIFICATION"
...
// Otherwise you can use the QIMMWPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the QIMMWPhoto class for an example implementation of this protocol
//
@protocol QIMMWPhoto <NSObject>
...
// See QIMMWPhoto object for an example implementation.
// When the underlying UIImage is loaded (or failed to load) you should post the following
// notification:
// [[NSNotificationCenter defaultCenter] postNotificationName:QIMMWPHOTO_LOADING_DID_END_NOTIFICATION
//                                                     object:self];
