...
- (UIView *)controlPanelView {
    if (!_controlPanelView) {
        ...
        [shareBtn setImage:[UIImage qimIconWithInfo:[QIMIconInfo iconInfoWithText:@"\U0000e0cf" size:18 color:[UIColor whiteColor]]] forState:UIControlStateNormal];
        [shareBtn setImage:[UIImage qimIconWithInfo:[QIMIconInfo iconInfoWithText:@"\U0000e0cf" size:18 color:[UIColor whiteColor]]] forState:UIControlStateSelected];
        ...
        [downloadBtn setImage:[UIImage qimIconWithInfo:[QIMIconInfo iconInfoWithText:@"\U0000f0aa" size:18 color:[UIColor whiteColor]]] forState:UIControlStateNormal];
        [downloadBtn setImage:[UIImage qimIconWithInfo:[QIMIconInfo iconInfoWithText:@"\U0000f0aa" size:18 color:[UIColor whiteColor]]] forState:UIControlStateSelected];
