...
@implementation QTPHAlbumsViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        _videoIcon.image = [UIImage imageNamed:@"QTPHVideoIcon" inBundle:[NSBundle bundleForClass:QTPHAlbumsViewCell.class] compatibleWithTraitCollection:nil];
        ...
        // TextLabel
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(90 + 10, 28.5, SCREEN_WIDTH - 90 - 20, 16.5)];
        _titleLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:17.0];
        _titleLabel.numberOfLines = 1;
        _titleLabel.adjustsFontSizeToFitWidth = YES;
        [self.contentView addSubview:_titleLabel];
        
        _infoLabel = [[UILabel alloc] initWithFrame:CGRectMake(90 + 10, self.titleLabel.bottom + 10, SCREEN_WIDTH - 90 - 20, 16.5)];
        _infoLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:14.0];
