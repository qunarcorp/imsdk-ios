...
#define kMaximumNumberOfSelection        9

@protocol QTPHImagePickerControllerDelegate;


/**
 *  A controller that allows picking multiple photos and videos from user's photo library.
 */
@interface QTPHImagePickerController : UIViewController

/**
 *  The assets picker’s delegate object.
 */
@property (nonatomic, weak) id <QTPHImagePickerControllerDelegate> delegate;
...
@protocol QTPHImagePickerControllerDelegate <NSObject>
...
- (BOOL)assetsPickerController:(QTPHImagePickerController *)picker shouldShowAsset:(PHAsset *)asset;
 ...
 */
- (BOOL)assetsPickerController:(QTPHImagePickerController *)picker shouldEnableAsset:(PHAsset *)asset;
 ...
 *
 */
- (BOOL)assetsPickerController:(QTPHImagePickerController *)picker shouldSelectAsset:(PHAsset *)asset;
 ...
 *
 */
- (void)assetsPickerController:(QTPHImagePickerController *)picker didSelectAsset:(PHAsset *)asset;
 ...
 *
 */
- (BOOL)assetsPickerController:(QTPHImagePickerController *)picker shouldDeselectAsset:(PHAsset *)asset;
 ...
 *
 */
- (void)assetsPickerController:(QTPHImagePickerController *)picker didDeselectAsset:(PHAsset *)asset;
 ...
 */
- (BOOL)assetsPickerController:(QTPHImagePickerController *)picker shouldHighlightAsset:(PHAsset *)asset;
 ...
 *
 */
- (void)assetsPickerController:(QTPHImagePickerController *)picker didHighlightAsset:(PHAsset *)asset;
 ...
 *
 */
- (void)assetsPickerController:(QTPHImagePickerController *)picker didUnhighlightAsset:(PHAsset *)asset;
