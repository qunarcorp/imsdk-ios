...
- (void) setup
{
	...
	// HS wheel
	KZColorPickerHSWheel *wheel = [[KZColorPickerHSWheel alloc] initAtOrigin:CGPointMake(15, 20)];
	...
	// brightness slider
	KZColorPickerBrightnessSlider *slider = [[KZColorPickerBrightnessSlider alloc] initWithFrame:CGRectMake(wheel.right + 10,60,self.width - wheel.right - 20,30)];
    ...
    // alpha slider
    KZColorPickerAlphaSlider *alpha = [[KZColorPickerAlphaSlider alloc] initWithFrame:CGRectMake(wheel.right + 10,100,self.width - wheel.right - 20,30)];
...
- (void) fixLocations
{
    ...
    if(self.bounds.size.width < self.bounds.size.height)
    {
        ...
        self.brightnessSlider.frame = CGRectMake(self.colorWheel.right + 10,
                                                 40,
                                                 self.width - self.colorWheel.right - 20,
                                                 38);
        
        self.alphaSlider.frame = CGRectMake(self.colorWheel.right + 10,
                                            90,
                                            self.width - self.colorWheel.right - 20,
                                            38);
    }
