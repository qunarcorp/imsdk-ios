//
//  QIMCustomPresentationController.m
//  QIMUIVendorKit
//
...
@interface QIMCustomPresentationController () <UIViewControllerAnimatedTransitioning>
...
@implementation QIMCustomPresentationController
...
- (instancetype)initWithPresentedViewController:(UIViewController *)presentedViewController presentingViewController:(UIViewController *)presentingViewController
{
    ...
    if (self) {
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(dimmingViewTappedNotify:) name:@"dimmingViewTappedNotify" object:nil];
    }
...
- (void)dimmingViewTappedNotify:(NSNotification *)notify {
    [self.presentingViewController dismissViewControllerAnimated:YES completion:NULL];
}
