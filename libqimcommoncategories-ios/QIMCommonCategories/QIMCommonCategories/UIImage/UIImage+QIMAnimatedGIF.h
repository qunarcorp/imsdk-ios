...
*/
+ (UIImage * _Nullable)qim_animatedImageWithAnimatedGIFData:(NSData * _Nonnull)theData;
...
*/
+ (UIImage * _Nullable)qim_animatedImageWithAnimatedGIFURL:(NSURL * _Nonnull)theURL;
