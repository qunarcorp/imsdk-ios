...
@interface QIMMWCaptionView : UIToolbar

// Init
- (id)initWithPhoto:(id<QIMMWPhoto>)photo;
...
// If you need more data per photo then simply subclass QIMMWPhoto and return your
