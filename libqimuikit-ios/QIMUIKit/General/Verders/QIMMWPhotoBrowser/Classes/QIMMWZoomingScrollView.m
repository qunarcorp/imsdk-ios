...
@interface QIMMWZoomingScrollView () {
    
    QIMMWPhotoBrowser __weak *_photoBrowser;
	QIMMWTapDetectingView *_tapView; // for background taps
	QIMMWTapDetectingImageView *_photoImageView;
...
@implementation QIMMWZoomingScrollView
...
- (id)initWithPhotoBrowser:(QIMMWPhotoBrowser *)browser {
    if ((self = [super init])) {
		...
		_tapView = [[QIMMWTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[QIMMWTapDetectingImageView alloc] initWithFrame:CGRectZero];
...
- (void)handleDoubleTap:(CGPoint)touchPoint {
	...
	if (self.zoomScale != self.minimumZoomScale && self.zoomScale != [self initialZoomScaleWithMinScale]) {
		...
		// Zoom out
        QIMVerboseLog(@"minimumZoomScale = %f", self.minimumZoomScale);
