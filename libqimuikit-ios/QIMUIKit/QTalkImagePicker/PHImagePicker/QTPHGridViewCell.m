...
@interface QTPHGridViewCell ()
@end


@implementation QTPHGridViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        _gifLabel.frame = CGRectMake(5, cellSize - 25, 30, 20);
        _gifLabel.text = @"GIF";
        ...
        _videoIcon.image = [UIImage imageNamed:@"QTPHVideoIcon" inBundle:[NSBundle bundleForClass:QTPHGridViewCell.class] compatibleWithTraitCollection:nil];
        ...
        [_selectedButton setImage:[UIImage imageNamed:@"photo_browser_checxbox_sel" inBundle:[NSBundle bundleForClass:QTPHGridViewCell.class] compatibleWithTraitCollection:nil] forState:UIControlStateSelected];
